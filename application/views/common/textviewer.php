                                        ...
                                        <div class="p-btn">
                                            <ul class="clearfix">
                                                <li class="<?=($controller == 'note') ? 'hide' : 'bookMark'?>">
                                                    <a class="bookMarkBtn" href="javascript:;" title="북마크"><i aria-hidden="true" class="fa fa-bookmark fa-1g <?=( isset($vdata['aDetail']['bookmark']) && $vdata['aDetail']['bookmark'] == 'Y' ) ? 'on' : ''?>"></i></a>
                                                    <!--<div>북마크</div>-->
                                                </li>
